# Installing Hello NEAR Contract
...
and then use the logged account to sign the transaction: `--accountId <another-account>`. - Python flask functions are also callable. 
